# Backlog de blog — Pizzería Popular

Plan de contenido: 1 post cada 15 días. Cada post entra en un pilar y apunta a
una keyword. Los primeros 4 son SENSIBLES A FECHA: respetar el orden.
La skill `/blog` toma el próximo post pendiente de esta lista.

Pilares: SEO local · Cultura · Producto · Marca · Estacional · Evento · Novedades.

## Sensibles a fecha — publicar en orden

| # | Título | Pilar | Keyword | Cuándo | Estado |
|---|--------|-------|---------|--------|--------|
| 1 | Dónde comer la mejor pizza en Benidorm: guía 2026 | SEO local | pizza en Benidorm | ya | pendiente |
| 2 | Viví el Mundial 2026 en Pizzería Popular: todos los partidos | Evento | ver el mundial 2026 | ANTES del 11/6 (arranca el Mundial) | pendiente |
| 3 | Hogueras de San Juan: festejá cerca de Luceros y Playa San Juan | Estacional / SEO local | hogueras Alicante | ~15-19/6 (Hogueras 20-24/6) | pendiente |
| 4 | Verano en la Costa Blanca: pizza con vista al mar en Benidorm | Estacional | comer en Benidorm verano | inicio de julio | pendiente |

## Evergreen — intercalar después

| # | Título | Pilar | Keyword | Estado |
|---|--------|-------|---------|--------|
...
- **Apertura de Benidorm: insistir** — Benidorm es prioridad; mantenerla
  presente (post #1, y mencionarla en otros donde encaje).
- **Mundial 2026**: el post #2 es sobre que se pueden ver TODOS los partidos en
  los locales. Argentina es campeona vigente → ángulo emocional fuerte para la
