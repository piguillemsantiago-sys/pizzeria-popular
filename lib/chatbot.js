...
function fechaBlock() {
  ...
  return '\n\nHOY ES: ' + hoy + ' (hora de España). MAÑANA ES: ' + manana + '. ' +
    'Usá estas fechas para todo lo relativo al calendario ("hoy", "mañana", ' +
    '"este miércoles") y para saber si una excepción o nota con fecha sigue ' +
    'vigente o ya pasó. No digas "mañana" o "pasado mañana" de una fecha salvo ' +
    'que coincida exacto con estos datos.';
}
