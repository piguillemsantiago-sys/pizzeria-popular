...
function fechaBlock() {
  ...
  return '\n\nHOY ES: ' + hoy + ' (hora de España). Usá esta fecha para todo lo ' +
    'relativo al calendario ("hoy", "mañana", "este miércoles") y para saber si ' +
    'una excepción o nota con fecha sigue vigente o ya pasó.';
}
