...
const PORTADA_IA_BRIEFS = {
  firma:
    ...
    'exact letterforms of the brand script shown in the typography reference sheet. The ' +
    'secondary line below in clean white geometric sans (style of "Montserrat"), ' +
  ...
  poster:
    ...
    'but at least 80% of every word stays visible. The secondary line in WHITE in the ' +
    'brand script: COPY its letterforms from the typography reference sheet EXACTLY, ' +
    'keeping its THIN elegant pen strokes — do NOT thicken it into a rounded marker ' +
    'script. ' + PORTADA_IA_LEGIBILIDAD,
};
...
async function disenoPortadaIA(frameBuf, titulo, estilo) {
  ...
  const estiloTxt = String(estilo || '').trim() ||
    ...
    '"Montserrat" (bold, uppercase, letterspaced). The secondary line may use the brand ' +
    'handwritten script (copy it from the typography reference sheet). Never mix more ' +
    'than 2 typefaces. Colors: white and warm gold (#F5C66B) accents only.';
  let muestra = null;
