...
5. Si hay CTA: es un botón pill dorado con el texto en oscuro. Si hay ubicación: etiqueta chica en mayúsculas espaciadas. Si hay cartel de evento: pill dorado chico en mayúsculas arriba del título, SIEMPRE por debajo de la franja superior despejada (nunca pegado al borde de arriba). Si hay banderas: una fila compacta con la bandera REAL de cada país y su NOMBRE escrito al lado en mayúsculas chicas (bandera + "FRANCIA", un "VS" dorado en el medio, bandera + "ESPAÑA" — con los nombres reales que te pasen), SIEMPRE por debajo de esa franja despejada, nunca a la altura del logo ni pegada al borde de arriba.
