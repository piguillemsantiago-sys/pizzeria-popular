...
async function generarImagenIA(prompt) {
  ...
  if (referenciaActiva()) {
    try {
      ...
      if (refs.length) {
        promptFinal += '\n\nUsá las imágenes adjuntas SOLO como referencia de paleta, luz y mood. IGNORÁ por completo cualquier texto, logo, isotipo, la letra P o gráfica que aparezca en ellas: NO los reproduzcas.';
        for (const r of refs) {
