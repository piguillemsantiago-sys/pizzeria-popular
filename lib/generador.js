...
const PORTADA_IA_BRIEFS = {
  firma:
    'The main title as a HUGE gold (#F5C66B) handwritten brush script (in the style of ' +
    '"Abuget"), like a chef signature crossing the frame. The secondary line below in ' +
    'clean white geometric sans (style of "Montserrat"), uppercase, generously ' +
    'letterspaced, LARGE enough to read easily on a phone. ' + PORTADA_IA_LEGIBILIDAD,
  poster:
    ...
    'but at least 80% of every word stays visible. The secondary line in a casual ' +
    'handwritten brush script (style of "Abuget") in WHITE so it never blends with warm ' +
    'tones. ' + PORTADA_IA_LEGIBILIDAD,
};
...
async function disenoPortadaIA(frameBuf, titulo, estilo) {
  ...
  const estiloTxt = String(estilo || '').trim() ||
    ...
    '"Montserrat" (bold, uppercase, letterspaced). The secondary line may use a casual ' +
    'handwritten brush script in the style of "Abuget". Never mix more than 2 typefaces. ' +
    'Colors: white and warm gold (#F5C66B) accents only.';
  const instr = (feedback) =>
    'You are editing this real photograph (a vertical 9:16 reel frame) from an Argentine ' +
    'wood-fired pizzeria.\n' +
    ...
    'TOP 120px completely free of text (a real logo goes at the bottom later).\n' +
