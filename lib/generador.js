...
async function disenoPortadaIA(frameBuf, titulo, estilo) {
  ...
  // default deja al PRO elegir el tratamiento elegante que mejor le quede.
  const estiloTxt = String(estilo || '').trim() ||
    'Elegant high-contrast serif OR bold condensed sans for the title, in white or warm ' +
    'gold (#F5C66B) accents; script only for the secondary line.';
