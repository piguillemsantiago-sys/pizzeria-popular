...
async function disenoPortadaIA(frameBuf, titulo) {
  ...
  const instr = (feedback) =>
    ...
    (sec ? '- Secondary line, EXACTLY: "' + sec + '" (smaller, elegant — a warm-gold script works beautifully)\n' : '') +
    '- Type style: elegant high-contrast serif OR bold condensed sans for the title, in white ' +
    'or warm gold (#F5C66B) accents; script only for the secondary line. Perfect kerning, ' +
    'razor-sharp, correctly spelled Spanish with accents.\n' +
...
module.exports = { generarCopy, ajustarCopy, generarPiezas, generarImagenIA, generarPortadaReel, generarPortadaEditorial, overlayTituloPortada, overlayTituloCaptura, afinarPromptIA, sugerirEscenaBlog, geminiDisponible, materializarFoto, componerPlaca, fotoDePlaca, interpretarRetoque, redactarPromptPlaca, verificarPlacaIA, generarPlacaCompletaIA, terminarPlacaIA, sanearCopy, acortarLargos, FORMATOS, LOGOS, ESTILO_LIST };
