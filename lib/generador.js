...
const PAISES = {
  es: 'España', sa: 'Arabia Saudita', ar: 'Argentina', fr: 'Francia', br: 'Brasil',
  gb: 'Inglaterra', de: 'Alemania', pt: 'Portugal', it: 'Italia', ma: 'Marruecos',
  mx: 'México', us: 'Estados Unidos', uy: 'Uruguay', co: 'Colombia', cl: 'Chile',
  nl: 'Países Bajos', hr: 'Croacia', be: 'Bélgica', jp: 'Japón', ec: 'Ecuador',
};
function nombrePais(code) {
  const c = String(code || '').toLowerCase();
  return PAISES[c] || c.toUpperCase();
}
