...
const DISENOS_CAPTURA = ['milanesa', 'boadilla', 'firma', 'dorado', 'arriba', 'marco', 'sello', 'neon'];
...
async function overlayTituloCaptura(imgBuf, titulo, diseno) {
  ...
  // ---- Diseños "libres" (marco / sello / neon): layout propio, retorno directo ----
  if (d === 'marco' || d === 'sello' || d === 'neon') {
