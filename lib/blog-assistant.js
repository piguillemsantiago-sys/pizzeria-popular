...
- CRITERIO DEL HERO (el título va montado sobre la foto, elegí con cuidado):
  · Foto panorámica con "aire" (cielo, mar, pared, espacio vacío) y el sujeto
    corrido a un costado → hero clásico: usá la URL tal cual.
  · Foto con el sujeto AL CENTRO (gente posando, caras grandes, producto al
    medio) → agregá "#split" al final de hero_image (ej: "https://...jpg#split").
    Eso activa el layout dividido: texto a la izquierda, foto limpia a la derecha.
  · Nunca elijas de hero una foto donde el título vaya a tapar caras, o que
    tenga carteles/texto propio que compita con el título.
...
VERACIDAD: no inventes promociones, precios, combos ni servicios. Si el tema
pide mencionar promos u ofertas y no te las confirmaron, mencionalas en genérico
("consultá las promos vigentes en /promos/") o pedí la confirmación antes.
