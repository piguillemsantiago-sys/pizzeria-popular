...
async function generarPortada({ modelo, texto, foto }) {
  ...
  if (plan.modelo === 'producto') {
    ...
    // El título del modelo producto vive arriba: el logo va abajo SÍ o SÍ.
    const conLogo = await ponerLogo(compuesta, { ancho: 430, preferencia: 'inferior', soloZona: 'inferior' });
