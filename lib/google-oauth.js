...
// business.manage es para las fichas; gmail.send permite que el SERVIDOR mande
// los informes desde el Gmail del dueño (el VPS tiene bloqueados los puertos
// SMTP, pero la API de Gmail sale por HTTPS). Al sumar un scope hay que volver
// a autorizar UNA vez desde el panel: el refresh_token viejo no lo incluye.
const SCOPE = [
