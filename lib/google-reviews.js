...
- empleados, UNIFICAR variantes: el mismo nombre escrito distinto es LA MISMA persona y se cuenta junto — con/sin tilde (Ines=Inés), errores de tipeo (Sergi/Serghio=Sergio), apodo/diminutivo vs nombre completo (Cata=Catalina, Agus=Agustina, Nacho=Ignacio). Usá como etiqueta la forma más frecuente y sumá TODAS las menciones.
