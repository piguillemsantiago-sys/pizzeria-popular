...
- Nunca elijas fotos con la etiqueta "descartable".
...
// placas: [{ titulo, bajada, cta }]. Devuelve [{ driveId, motivo }] por placa.
async function elegirFotos(instruccion, formato, placas) {
